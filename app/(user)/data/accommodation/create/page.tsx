...
import { createAccommodation } from "@/lib/api/accommodationApi";
...
export default function CreateAccommodationPage() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-6 text-center">Create Accommodation</h1>
      <div className="bg-white shadow rounded p-6 space-y-4">
        {[
          ...
          <div key={field.name}>
            ...
            {field.name === "type" ? (
              ...
              <textarea
                name={field.name}
                value={form[field.name as keyof AccommodationForm]}
                onChange={handleChange}
                className="w-full p-2 border rounded"
              />
            ) : (
        ...
        <div className="flex justify-between">
          ...
          <button
            onClick={async () => {
              try {
                const res = await createAccommodation(form);
                if (res) {
