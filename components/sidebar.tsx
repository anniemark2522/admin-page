...
export const SideBar = () => {
    ...
    const asideStyle = classNames("sidebar overflow-y-auto overflow-x-auto fixed bg-red-900 h-full shadow-sm shadow-slate-500/40 transition duration-300 ease-in-out z-[99999]",
        {
